...
function attachDomListeners(sendToHost: (message: unknown) => void) {
    refs.addBtn.onclick = () => {
...
export function getRunPayload(type: string) {
...
export function openEditor(index: number) {
    selectedIndex = index;
...
export function loadWorksheetFromHost(data: any) {
...
export function applyHostResult(msg: any) {
