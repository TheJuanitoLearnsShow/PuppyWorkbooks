...
public class InterpreterTests
{
    ...
    public async Task Test_Interpretation()
    {
        ...
        workbook.Cells.Add(new PuppyWorkbooks.WorkCell(1, "MaxLimit", "Age * 4", "None"));
        workbook.Cells.Add(new PuppyWorkbooks.WorkCell(1, "Levels", "Table( { Value: MaxLimit }, { Value: 3 } )", "None"));
